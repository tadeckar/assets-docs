...
Loads data of the `MERAKI_LICENSE` [File Type](/pages/tadeckar/assets-docs/ingestion/types/file-types).
...
Next, a thread is spun up to load the data, executing the [DataLoadManager](/pages/tadeckar/assets-docs/ingestion/managers/data-load-manager), which in turn executes a Loader for the [License Data Load Type](/pages/tadeckar/assets-docs/ingestion/types/data-load-types#license).
